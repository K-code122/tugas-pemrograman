...
class MyListAdapter(var mCtx: Context, var resource: Int, var items: List<Model>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val imageView: ImageView = view.findViewById(R.id.listicon)
        var textView: TextView = view.findViewById(R.id.titleicon)
        var textView1: TextView = view.findViewById(R.id.descicon)
